...
{
    /// <summary>
    /// Este es un curso de vida personalizado para preservar la instancia en la misma entorno de ejecución. 
    /// Por ejemplo, en una solicitud WCF o solicitud de ASP.NET, diferente cuando se llame a recolver este devuelve la misma instancia.
    /// </summary>
